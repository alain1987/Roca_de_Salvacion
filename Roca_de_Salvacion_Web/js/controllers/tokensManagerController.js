'use strict';
app.controller('tokensManagerController', ['$scope', 'tokensManagerService', 'passDataService', '$location', function ($scope, tokensManagerService, passDataService, $location) {
    $scope.refreshTokens = [];
